package com.assignsecurities.service.impl.doc.processor.rta;
...
public class RtaDocPlaceHolderDataProcessor extends DocPlaceHolderDataProcessor {
...
//		${ApplicantBankAddress}
		...
		substitutionData.put("ApplicantPANnumber",caseTemplateBean.getPanNumber());
		substitutionData.put("ApplicantAadharcardnumber",caseTemplateBean.getAadharNumber());
		substitutionData.put("Applicantemailid",caseTemplateBean.getEMail());
