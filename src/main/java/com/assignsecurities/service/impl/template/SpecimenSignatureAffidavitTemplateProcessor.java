...
public class SpecimenSignatureAffidavitTemplateProcessor extends TemplateProcessorAbstract implements TemplateProcessor {
...
//		RtaTemplateModel rtaTemplateModel1 = getRtaTemplate(rtaDataModel.getRegistrarName(), caseDocumentBean.getTemplateType());
		...
		if (storeDoc) {
			...
			DocumentMasterModel documentMasterModel =  utilityRepo.getMasterDocument(AppConstant.DocumentType.SpecimenSignatureAffidavit.label);
