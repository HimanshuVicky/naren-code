...
public class RtaLetter2TemplateProcessor extends TemplateProcessorAbstract implements TemplateProcessor {
...
//		RtaTemplateModel rtaTemplateModel1 = getRtaTemplate(rtaDataModel.getRegistrarName(), caseDocumentBean.getTemplateType());
		...
		if (storeDoc) {
			...
			DocumentMasterModel documentMasterModel =  utilityRepo.getMasterDocument(AppConstant.DocumentType.RtaLetter2.name());
