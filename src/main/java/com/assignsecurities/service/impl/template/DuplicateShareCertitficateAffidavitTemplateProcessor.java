...
public class DuplicateShareCertitficateAffidavitTemplateProcessor extends TemplateProcessorAbstract implements TemplateProcessor {
...
//		RtaTemplateModel rtaTemplateModel1 = getRtaTemplate(rtaDataModel.getRegistrarName(), caseDocumentBean.getTemplateType());
		...
		if (storeDoc) {
			...
			DocumentMasterModel documentMasterModel =  utilityRepo.getMasterDocument(AppConstant.DocumentType.DuplicateShareCertitficateAffidavit.label);
